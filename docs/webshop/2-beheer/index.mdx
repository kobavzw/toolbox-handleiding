...
- **Label bij datumkeuze**: Indien er in een volgende stap [keuzemomenten](/webshop/keuzedatums_of_uren_instellen/) ingesteld zullen worden, kan men hier opgeven welke tekst er in de webshop getoond moet worden bij deze datumkeuze. Bv. _Selecteer hier uw afhaalmoment_.
...
- **publiek beschikbaar**: iedereen met de URL kan de webshop raadplegen en bestellingen plaatsen. De URL vind je terug via de webshop pagina. Zie ook [Webshop publiceren](/webshop/webshop%20publiceren/).
...
- **Externe kunnen beheren en opvolgen**: Je stelt de webshop open voor de externen die het gebruikersrecht _webshop_beheer_ of _webshop_bestellingen_opvolgen_ hebben. Zie ook [Webshop Externen](/webshop/webshop%20externen/)
