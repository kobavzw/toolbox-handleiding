...
- **Opmerkingen verplicht in te vullen**: Indien aangevinkt, zal de klant verplicht het opmerkingenveld moeten invullen bij de bestelling.  
...
- **Label bij datumkeuze**: Indien er in een volgende stap keuzemomenten [datums](/webshop/keuzedatums_of_uren_instellen/ ingesteld) zullen worden, kan men hier opgeven welke tekst er in de webshop getoond moet worden bij deze datumkeuze. Bv. *Selecteer hier uw afhaalmoment*. 
