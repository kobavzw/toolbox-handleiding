...
## Extra info toevoegen aan artikel

Om extra info of een beschrijving toe te voegen aan een artikel klik je in de kolom 'Info' op <LegacyAction img="info.png" />. Een blauwe bol geeft weer dat er info beschikbaar is voor een artikel. Deze info wordt ook getoond in de webshop.
