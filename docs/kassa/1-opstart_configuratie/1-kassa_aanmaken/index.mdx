...
Alvorens met de module Kassa te kunnen starten, dienen de benodigde kassa's te worden aangemaakt in de module **Instellingen** van de Toolbox. Hiervoor zijn beheersrechten vereist die toegang geven tot deze module. Je kan tot 8 verschillende kassa's instellen. 
...
**Payconiq | SumUp | Exern betaalsysteem**: Hiermee registreer je enkel dat de betaling heeft plaatsgevonden via een bepaald systeem. Deze registraties kunnen per betaalmiddel opgevolgd worden in het menu 'Opvolging verkopen'. Er is echter geen koppeling voorzien met deze externe systemen. 
