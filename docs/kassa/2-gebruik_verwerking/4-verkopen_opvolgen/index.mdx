...
## <LegacyAction img="verkopen.png"/> Opvolging verkopen (cash, wallet, POM)

Is er gekozen om **cash** te betalen of via de **wallet of POM**, dan kunnen de verkopen via deze weg worden opgevolgd. Je kan kiezen om de cash betalingen óf de niet-cash (POM en wallet) betalingen voor een bepaalde periode te tonen in het overzicht. Deze gegevens kunnen worden geëxporteerd naar Excel door op de knop <LegacyAction img="excel.png" text="Exporteer naar Excel"/> te klikken.
