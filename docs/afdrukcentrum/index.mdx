...
Als endpoint vul je https://mijn.toolbox.be/public/afdrukcentrum/ in. Zorg dat de Ref overeenkomt met de instellingen in de import van Uniflow gebruikers ([Canon Uniflow](canon_uniflow)).
