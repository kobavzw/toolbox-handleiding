...
Om wachtrijen aan te maken en te beheren en om goedkeurders en verwerkers toe te wijzen is het gebruikersrecht **onkosten_beheer** noodzakelijk. Gebruikersrechten kan je toekennen via de module [Gebruikersbeheer](/gebruikersbeheer).
