...
Helemaal onderaan de pagina kan je het aantal dagen van de betaaltermijn invoeren. Bij gebruik van de dynamische variabele $$TE_BETALEN_VOOR$$, wordt er op de herinneringsbrief automatisch een vervaldatum gegenereerd o.b.v. het hier ingevoerde getal. 

Indien er een overkoepelende Toolbox is, worden deze gegevens door Toolbox zelf ingevuld. Dit veld moet nooit door een gebruiker of beheerder worden aangepast. 

![OF_instellingen3](./OF_instellingen3.jpg)
