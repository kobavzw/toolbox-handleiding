...
Door een bepaald **dagboek** of een bepaalde **notagroep** te selecteren, worden enkel de openstaande facturen van dat dagboek of van die notagroep getoond.
...
![openstaanden](./openstaanden6.jpg)

### <LegacyAction img="person.png"/> <LegacyAction img="budget.png"/> Betalingsregeling relatie wijzigen
...
### <LegacyAction img="person.png"/> <LegacyAction img="edit.png"/> Opmerking bij relatie wijzigen
...
De teksten kunnen gedefinieerd en aangepast worden in de module [Instellingen](./openstaande_facturen/instellingen) of rechtstreeks in de module Openstaande facturen (indien deze optie is geactiveerd in de module Instellingen). [Hier](/openstaande_facturen/voorbeeldteksten) vind je enkele voorbeeldteksten. 
