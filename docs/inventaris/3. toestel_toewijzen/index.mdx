...
Selecteer in de module **Inventaris => Facturen** de terugbetalingen en zet ze over naar de module Leerlingenrekeningen. De facturen worden daar aangemaakt in een aparte school 'Inventaris'. Vanuit de module Leerlingenrekeningen kunnen de facturen verstuurd worden naar de ouders en overgezet naar Exact Online. 

![toewijzen14](./toewijzen14.png)
