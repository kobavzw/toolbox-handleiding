...
Het veld **serienummers** is groot en kan meerdere serienummers bevatten; telkens één serienummer per lijn. **Hierdoor kan je in één beweging meerdere items van dezelfde soort, leverancier en facturatiedatum aanmaken.** Denk maar aan een bestelling van 30 laptops van hetzelfde type. Het aantal items wordt automatisch door Toolbox geteld en ingevuld. Aan de hand daarvan kan je nagaan of het aantal ingegeven serienummers overeenkomt met het aantal toestellen dat je wil toevoegen.
