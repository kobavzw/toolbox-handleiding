...
- Stap 2: Geef een reden op en een begin- en (voorlopige) einddatum. Extra redenen kan je instellen in de module Instellingen => Afwezigheden.
...
- Stap 4: Voeg de afwezigheid toe. De afwezigheid wordt geregistreerd en komt onderaan in het overzicht te staan. 
  ...
  Leerkrachten die vrijkomen omwille van de afweziheid van een klas, kan je in een latere fase kiezen als toezichthoudende leerkracht voor een klas die op de vervangingslijst staat. 
