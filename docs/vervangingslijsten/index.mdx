...
In deze module kan je per dag een vervangingsrooster opstellen. Daarvoor wordt er informatie gehaald uit het [lessenrooster](/lessenrooster), aangevuld met de [afwezigheden](/afwezigheden) van de leraren en eventueel gekoppelde vervangingen, alsook klassen die afwezig zijn (bijvoorbeeld wegens uitstappen).
...
- Stap 1: Kies een voorgedefinieerde vervangingslijst of selecteer voor welke jaren je een rooster wil maken.
