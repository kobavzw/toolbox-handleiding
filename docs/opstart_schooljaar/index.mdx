...
1. In de module **Instellingen => Schooljaar**. Deze werkwijze is enkel toegankelijk voor een **beheerder** in Toolbox. 
    ...
    Kijk hieronder bij [a. Informat](/opstart_schooljaar#11-informat) en [b. Wisa](/opstart_schooljaar#12-wisa) om na te gaan welke velden je precies moet invullen afhankelijk van het administratief pakket waarmee je werkt. 
