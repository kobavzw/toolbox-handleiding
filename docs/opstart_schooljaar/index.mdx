...
- Bij de rubriek **Informat** vul je bij de onderdelen **Schooljaar Informat Leraren** en **Schooljaar Informat Leerlingen** het nieuwe schooljaar in. Gebruik daarvoor het volgende formaat: '2024-25'.
- Het veld onder **Inschrijvingen** maak je leeg.
- Bij de rubriek **Informat en Wisa** => **Schooljaar leerlingen Informat en Wisa** vul je '2024' in 
- Bij **Exact Online** vul je '2024-25' in.
...
Dat doe je via de module **Instellingen => Informat => Gegevens => Referentiedatum leerling**. Daar vul je 01/09/2024 in als datum.
...
- Vul  bij de rubriek **Informat en Wisa** '2024' in. 
- Het veld onder **Inschrijvingen** maak je leeg.
- Bij **Exact Online** vul je '2024-25' in.

![opstart1.1](./opstart1.1.PNG)

Wil je al in augustus gegevens van het nieuwe schooljaar ophalen, dan vul je in de module **Instellingen => Wisa => Synchronisatiedata** => de 'Werkdatum leraren' en 'Werkdatum leerlingen' in: 01/09/2024.
...
- Eerst en vooral wijzig je het **Schooljaar loopbanen leerlingen**: hier vul je '2024-25' in.
- Als datum voor **Leerlingen inschrijven op** gebruik je '2024-09-01'.
- Als **uitschrijfdatum indien geen datum gevonden** kies je voor '2024-08-31'.
...
Als het nieuwe schooljaar 2024-2025 nog niet is aangemaakt, klik je bovenaan op de blauwe plus en vervolgens op toevoegen.
...
## 6. Nieuwe Toolbox-gebruikers/personeelsleden
Heb je nieuwe Toolbox-gebruikers in je school? Zorg dan dat ze eerst in het administratief pakket voor personeelsadministratie (Informat, Wisa, Broekx of DKO3) worden aangemaakt. Laat vervolgens
...
Wil je in augustus al synchroniseren met Office 365, stel dan in de module **Instellingen => Office 365** de referentiedatum in op 01/09/2024. 
...
Het schooljaar van het Afdrukcentrum kan je instellen in de module **Instellingen => Uniflow**. Daar vul je als schooljaar '2024-25' in.

Wil je het afdrukcentrum reeds in augustus ter beschikking stellen? Vul dan in de module **Instellingen => Afdrukcentrum** de referentiedatum in op 1 september 2024.

:::caution belangrijk
Vanaf 1 september maak je het veld 'referentiedatum' terug leeg om de actuele situatie te zien.
:::

## 9. Vakanties en schoolvrije dagen

Vul via de module **Instellingen => Vakanties en vrije dagen** de schoolvakanties en andere vrije dagen in voor volgend schooljaar. Met deze gegevens wordt rekening gehouden in volgende modules:
- **Fietsvergoeding**: Dagen die in een vakantie of op een schoolvrije dag vallen, worden aangeduid met een rood kadertje. Hiermee wordt er enkel visueel duidelijk gemaakt dat het gaat om een dag waarop er normaal gezien niet wordt gewerkt. Een personeelslid kan deze dag alsnog aanduiden als 'gefietst'.
