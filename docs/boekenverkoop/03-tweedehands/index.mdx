...
Leerlingen surfen naar de Toolbox voor leerlingen (https://mijnschool.tbvs.be/leerling) en loggen daar aan met hun account. In de module Tweedehands kunnen ze vervolgens aangeven welke boeken ze wensen in te leveren. Als eerste stap wordt gevraagd naar een rekeningnummer. Indien de ingeleverde boeken niet worden terugbetaald door ze in mindering te brengen van een nieuw-factuur,  kunnen ze op dit rekeningnummer terugbetaald worden. Deze stap is optioneel en kunnen leerlingen overslaan.
...
In de laatste stap krijgen ze voor elk boek een fiche met barcode te zien. Die fiche printen ze af en steken ze in het overeenkomstige boek en leveren het zo binnen.

<Thumbnails img={[
    require('./tweedehands4.png').default, 
    require('./tweedehands5.png').default, 
    require('./tweedehands6.png').default, 
    require('./tweedehands7.png').default, 
]} />

In de module Boekenverkoop kan je via Tweedehands - overzicht alle geregistreerde fiches opvolgen. Elke lijn is een fiche en bij Binnengebracht kan je zien wanneer een boek effectief werd ingeleverd.

![tweedehands3](./tweedehands8.png)

Zodra de leerling de boeken komt inleveren, kan de module Tweedehands - Inleveren (scannen) gebruikt worden. Door middel van een barcodescanner kan de barcode gescand worden en wordt het boek als 'ingeleverd' gemarkeerd. Het is ook mogelijk om de code die onder elke barcode staat manueel in te voeren en te enteren.

<Thumbnails img={[
    require('./tweedehands9.png').default, 
    require('./tweedehands10.png').default, 
]} />
...
<Thumbnails img={[
    require('./tweedehands12.png').default, 
    require('./tweedehands13.png').default, 
]} />