...
Zolang een factuur nog niet verwerkt is naar de module Leerlingenrekeningen, is het nog steeds mogelijk om de uitlevering volledig of gedeeltelijk terug ongedaan te maken. Open hiervoor de betreffende bestelling via het klembordicoon <LegacyAction img="list.png"/> en klik achter het gewenste item op <LegacyAction img="back.png"/>. Het item zal terug van de factuur verwijderd worden. De overige icoontjes worden opnieuw beschikbaar voor gebruik. Meer info over de icoontjes vind je terug onder punt [5.1 Adminmodule](/boekenverkoop/bestelling/#51-adminmodule).
