...
## Huurboek als artikel

Om een boek 'te huur' aan te kunnen bieden, moet het eerst (slechts 1 exemplaar) ingegeven worden in de lijst met artikels in het menu **Artikels**. Klik [hier](/boekenverkoop/artikels/#artikels-ingeven-in-toolbox) om te lezen hoe je artikels kan aanmaken of importeren. 
...
## Huurboeken ingeven, beheren & barcodes genereren
...
## Overzicht verhuurde boeken & verhuur stopzetten
