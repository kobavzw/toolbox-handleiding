...
Via het menu **Huur > Huurboeken** kan je opgeven hoeveel exemplaren van een bepaalde titel de school in haar bezit heeft. Klik op de witte plus om een nieuwe reeks huurboeken toe te voegen. Het **label** dat hier gevraagd wordt, is de **interne code** van dit betreffende boek in de artikellijst. Bij 'Voeg meerdere keren toe' kan je het aantal exemplaren van deze titel opgeven.  
