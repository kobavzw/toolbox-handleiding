...
De prijs van een artikel kan aangepast worden in het menu **Artikels**. Dat kan zowel via het edit-icoon <LegacyAction img="edit.png"/> als via de blauwe link (de prijs) in het globaal overzicht. 
