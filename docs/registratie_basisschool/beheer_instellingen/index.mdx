...
**Naam item**: De benaming die je aan het item toekent is zichtbaar in de module Registratie Basisschool wanneer je met de cursor op de afkorting van het item staat. Dit is tevens de naam die je kan selecteren bij het importeren van de registraties in de module Leerlingenrekeningen. Meer info hierover vind je in het onderdeel [importeren](/importeren).   
