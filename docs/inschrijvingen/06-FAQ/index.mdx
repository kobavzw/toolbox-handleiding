...
## 5. De quota zijn nog niet bereikt, maar wanneer ik mijn niet gerealiseerde thuisaanmelding finaliseer, blijft deze “niet gerealiseerd”.
...
## 6. Als ik het overzicht van een studierichting raapleeg, is het aantal geraliseerde inschrijvingen hoger dan het effectief aantal gerealiseerde inschrijvingen.
...
## 7. Zij-instromers moeten al kunnen aanmelden/inschrijven voor volgend schooljaar, maar ik wil voldoende plaatsen reserveren voor eigen leerlingen. 
...
- In studierichting X zijn voor volgend schooljaar 24 plaatsen voorzien. Er wordt verwacht dat 22 van de 24 plaatsen ingenomen zullen worden door eigen leerlingen. Er zijn momenteel dus 2 plaatsen beschikbaar voor zij-instromers. 
    ...
    - Pas het quota op de studierichtinge aan naar 24. Je kan nu de 2 eerste aanmeldingen op de wachtlijst realiseren en eventueel finaliseren. 


## 8. Bij het synchroniseren naar Informat zijn er foutmeldingen. Wat nu?
