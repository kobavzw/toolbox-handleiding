...
Alvorens te kunnen mailen moeten er een aantal zaken worden ingesteld in de module Instellingen > RL. Deze module is enkel toegankelijk voor een Toolbox-beheerder. Om te weten wie beheerder is in een Toolbox, klik je in het startscherm op het vraagteken > contact. Indien er bij 'Afzender mail' geen afzender beschikbaar is of niet de juiste afzender, moet die nog geconfigureerd worden in de module Instellingen > [E-mail](/e-mail).
