...
- Klik op <LegacyAction img="info2.png"/> om de **wensen** van de leraar m.b.t. diens opdracht in te geven. Diezelfde wensen kan je ook ineens invoeren bij het ingeven van de details omtrent administratieve toestand en vaste benoeming via het potloodje <LegacyAction img="edit.png"/>. Wanneer er voor een leraar wensen zijn ingevuld, ziet het icoontje er als volgt uit: <LegacyAction img="info.png"/>.
