...
description: "Module Synchronisatie: synchronisatie O365 via app-credentials, nieuwe app-registratie, machtiging toevoegen, clientgeheim toevoegen."
---
...
- Bij Tennat ID vul je de map-id / tennant Id uit stap 1 in.
