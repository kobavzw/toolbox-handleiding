...
- De Toepassings-id uit stap 2 vul je in bij de Client ID.
- De gekopieerde “waarde” uit stap 4 vul je in bij de Client Secret.
- Bij de login URL vul je de volgende URL in waarbij je de *** vervangt door de Map-id uit stap 2: https://login.microsoft.com/***/oauth2/token .
