...
De module Synchronisatie leraren haalt gegevens van personeel uit Informat of Wisa op. In de module Instellingen > Synchronisatie leraren kan je instellen uit welke software de gegevens moeten komen.
...
Informat/Wisa uitlezen = het ophalen van de gegevens in Informat of Wisa
Synchroniseer leraren = het intern synchroniseren/gegevens overzetten naar Toolbox
