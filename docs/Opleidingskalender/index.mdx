...
Toolbox organiseert in samenwerking met de **dienst Onderwijsondersteuning van KOBA** een eerste opleidingsdag voor personeelsadministraties. In de voormiddag zal je kunnen kiezen uit een aantal Toolbox-sessies waarin modules centraal staan die je kunnen ondersteunen bij het voeren van de personeelsadministratie. Denk hierbij aan de modules Functiebeschrijvingen, RL/Persona, Weddecontrole, Opdrachten, Afwezigheden en Vervangingslijsten, Adresboek, Fotolijsten, ... In de namiddag staan er infosessies op het programma rond de reïntegratie van langdurig afwezige personeelsleden en ook de nieuwigheden in de administratie voor schooljaar 2025-2026 komen aan bod. 

    - Wanneer: Dinsdag **30 september 2025**  
    - Waar: KOBA - Nooitrust 4 - 2390 Malle  
    - Voorkennis:  Geen voorkennis vereist  
    - Duur: Dagopleiding - keuze uit verschillende sessies. Het concrete programma volgt binnenkort. 
    - Vooraf inschrijven vereist: De inschrijflink wordt hier weldra gepubliceerd.
