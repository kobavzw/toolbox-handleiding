...
Vooraleer je aan de slag kan gaan met de module **Verwerking schoolfoto's**, moet je een aantal zaken instellen in de module **Instellingen** van Toolbox > Schoolfoto's. Deze module is enkel toegankelijk voor een beheerder van Toolbox. Om te weten wie je beheerder is, klik je rechtsbovenaan op het vraagteken > contact. 
