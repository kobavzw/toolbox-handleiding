...
<LegacyAction img="schild.PNG" text="Gebruikers aan beveiligingsgroepen koppelen" /> 
...
<LegacyAction img="groep.PNG" text="Beveiligingsgroepen aan gebruikers koppelen" />
...
<LegacyAction img="slot.PNG" text="Paswoord wijzigen" />
