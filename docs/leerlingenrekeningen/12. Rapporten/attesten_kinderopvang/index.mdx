...
Aan de hand van het  waarschuwingsicoon <LegacyAction img="alert.png"/> kan je achterhalen welke gegevens ontbreken. In het voorbeeld hieronder is er geen leerplichtverantwoordelijke opgegeven in het administratief pakket OF er geen adres gekoppeld aan deze LPV. Hoe je een adres koppelt aan een LPV kan je hieronder terugvinden bij [6.2 situatie 2](/fiscale_attesten_kinderopvang#62-foutieve-persoonsgegevens-op-het-attest-zelf). 
