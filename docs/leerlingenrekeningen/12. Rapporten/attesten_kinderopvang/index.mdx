...
### 2.3 Rijksregisternummers controleren
...
## 4. Attest aanpassen (bedrag en aantal dagen)
...
:::tip tip
Indien een attest volledig moet worden overgezet op naam van de andere leerplichtverantwoordelijke, doe dan de aanpassing meteen in het administratief pakket (Informat of Wisa). Op die manier blijft de info behouden voor de volgende schooljaren en zal je in Toolbox geen manuele aanpassingen meer moeten doen. Klik [hier](/fiscale_attesten_kinderopvang#62-foutieve-persoonsgegevens-op-het-attest-zelf) voor de juiste werkwijze.
:::
...
## 6. Foutieve of ontbrekende persoonsgegevens op de fiscale attesten
...
### 6.1 Foutmeldingen in het overzicht (rode lijnen)

In volgende gevallen worden de attesten in het overzicht getoond als rode lijnen:
- Geen leerplichtverantwoordelijke (LPV) aangeduid in het administratief pakket (Informat/Wisa)
- Geen rijks- of bisregisternummer ingegeven voor de leerling in het administratief pakket (Informat/Wisa)

Aan de hand van het  waarschuwingsicoon <LegacyAction img="alert.png"/> kan je achterhalen welke gegevens ontbreken. In het voorbeeld hieronder is er geen leerplichtverantwoordelijke opgegeven. 
...
### 6.2 Foutieve persoonsgegevens op het attest zelf
...
De attesten in Toolbox worden NIET AUTOMATISCH GEÜPDATET na aanpassingen in het administratief pakket. Je zal de foutieve attesten moeten verwijderen en opnieuw genereren. Vink hiervoor alle foutieve attesten in Toolbox aan verwijder ze via het rode kruisje <LegacyAction img="remove.png"/> bovenaan. 

Klik opnieuw op de rekenmachine <LegacyAction img="calculator.png"/> om de gecorrigeerde attesten aan te maken. Voor leerlingen die reeds een correct attest hadden in het overzicht, zal met deze actie geen nieuw (lees: dubbel) attest aangemaakt worden. 

### 6.3 Voor leerlingen die uitgeschreven zijn, worden de aanpassingen niet automatisch mee overgenomen naar Toolbox na synchronisatie.
